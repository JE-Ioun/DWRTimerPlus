...
Public Class Settings
    ...
    Private Sub btnSimulateDLFights_Click(sender As Object, e As EventArgs) Handles btnSimulateDLFights.Click
        frmTracker.txtDragonLordSimChance.Text = SimulateDLFights(CalculateAttackPower(frmTracker), CalculateDefense(frmTracker), My.Settings.intAgility, My.Settings.intHP, My.Settings.intMP, nudDLSimStartingHerbs.Value, nudNumberOfSimulations.Value, nudDLSimMinHealth.Value, tbDifficultyEstimate.Value)
        frmTracker.txtDragonLordSimChanceDN.Text = SimulateDLFights((CalculateAttackPower(frmTracker)) + 10, CalculateDefense(frmTracker), My.Settings.intAgility, Math.Floor(My.Settings.intHP * 0.75), My.Settings.intMP, nudDLSimStartingHerbs.Value, nudNumberOfSimulations.Value, nudDLSimMinHealth.Value, tbDifficultyEstimate.Value)
    End Sub
